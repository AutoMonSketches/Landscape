...
#define LABTEST_PHONE   "+639603510337" //Brix
#define LABTEST_PHONE2  "+639173449601" // Maui
...
//   spiuart.println(str);
  ...
  //String str1="GET https://api.thingspeak.com/update?api_key=43GYIJ1GJN55CBKP&field1=" + String(buf1)+"&field2="+ String(buf2); //11April2024
   ...
   String str="GET https://api.thingspeak.com/update?api_key=Z9SRXU5TC57YPXM2&field1=" + String(x)+"&field2="+ String(y)+"&field3="+ String(buf3); //15April 2024 removed the placement holder z
   Serial.println(str);
   spiuart.println(str);
   delay(4000);
